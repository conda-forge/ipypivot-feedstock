About ipypivot-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipypivot-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4892&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipypivot-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipypivot` can be installed with `conda`:
...
```
mamba install ipypivot
```

It is possible to list all of the versions of `ipypivot` available on your platform with `conda`:
...
```
mamba search ipypivot --channel conda-forge
```
...
mamba repoquery search ipypivot --channel conda-forge

# List packages depending on `ipypivot`:
mamba repoquery whoneeds ipypivot --channel conda-forge

# List dependencies of `ipypivot`:
mamba repoquery depends ipypivot --channel conda-forge
```
